...
describe("Addition", () => {
  it("Add two positive rational numbers", () => {
    ...
    expect(new Rational(1, 2).addition(new Rational(2, 3))).toEqual(expected)
  })
  ...
  it("Add a rational number to its additive inverse", () => {
    ...
    expect(new Rational(1, 2).addition(new Rational(-1, 2))).toEqual(expected)
  })
})
...
describe("Subtraction", () => {
  it("Subtract two positive rational numbers", () => {
    const expected = new Rational(-1, 6)
    expect(new Rational(1, 2).subtraction(new Rational(2, 3))).toEqual(expected)
  })
  ...
  it("Subtract a rational number from itself", () => {
    const expected = new Rational(0, 1)
    expect(new Rational(1, 2).subtraction(new Rational(1, 2))).toEqual(expected)
  })
})
...
describe("Multiplication", () => {
  it("Multiply two positive rational numbers", () => {
    ...
    expect(new Rational(1, 2).multiplication(new Rational(2, 3))).toEqual(expected)
  })
  ...
  it("Multiply a rational number by its reciprocal", () => {
    ...
    expect(new Rational(1, 2).multiplication(new Rational(2, 1))).toEqual(expected)
  })

  it("Multiply a rational number by 1", () => {
    const expected = new Rational(1, 2)
    expect(new Rational(1, 2).multiplication(new Rational(1, 1))).toEqual(expected)
  })

  it("Multiply a rational number by 0", () => {
    const expected = new Rational(0, 1)
    expect(new Rational(1, 2).multiplication(new Rational(0, 1))).toEqual(expected)
  })
})
...
describe("Division", () => {
  it("Divide two positive rational numbers", () => {
    ...
    expect(new Rational(1, 2).division(new Rational(2, 3))).toEqual(expected)
  })
  ...
  it("Divide a rational number by 1", () => {
    const expected = new Rational(1, 2)
    expect(new Rational(1, 2).division(new Rational(1, 1))).toEqual(expected)
  })
})
...
describe("Exponentiation of a rational number", () => {
  it("Raise a positive rational number to a positive integer power", () => {
    ...
    expect(new Rational(1, 2).exponentRationalNumber(3)).toEqual(expected)
  })
  ...
  it("Raise zero to an integer power", () => {
    const expected = new Rational(0, 1)
    expect(new Rational(0, 1).exponentRationalNumber(5)).toEqual(expected)
  })

  it("Raise one to an integer power", () => {
    const expected = new Rational(1, 1)
    expect(new Rational(1, 1).exponentRationalNumber(4)).toEqual(expected)
  })

  it("Raise a positive rational number to the power of zero", () => {
    const expected = new Rational(1, 1)
    expect(new Rational(1, 2).exponentRationalNumber(0)).toEqual(expected)
  })
...
describe("Exponentiation of a real number to a rational number", () => {
  it("Raise a real number to a positive rational number", () => {
    const expected = 16.0
    expect(new Rational(4, 3).exponentRealNumber(8)).toEqual(expected)
  })

  it("Raise a real number to a negative rational number", () => {
    const expected = 1.0 / 3.0
    expect(new Rational(-1, 2).exponentRealNumber(9)).toBeCloseTo(expected, 15)
  })

  it("Raise a real number to a zero rational number", () => {
    const expected = 1.0
    expect(new Rational(0, 1).exponentRealNumber(2)).toEqual(expected)
  })
})
